...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.upload'
        db.delete_column(u'blog_post', 'upload')


    def backwards(self, orm):
        # Adding field 'Post.upload'
        db.add_column(u'blog_post', 'upload',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2014, 10, 14, 0, 0), max_length=100),
                      keep_default=False)
