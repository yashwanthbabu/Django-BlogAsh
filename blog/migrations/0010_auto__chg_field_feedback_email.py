...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_feedback', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'Feedback.email'
        db.alter_column(u'blog_feedback', 'email', self.gf('django.db.models.fields.EmailField')(max_length=25))
